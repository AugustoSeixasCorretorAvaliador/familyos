...
const FIELD_LABELS: Array<{ key: string; label: string }> = [
  ...
  { key: "ano_fabricacao", label: "Ano de fabricacao" },
  { key: "ano_modelo", label: "Ano do modelo" },
  { key: "seguradora", label: "Seguradora" },
  { key: "numero_apolice", label: "Numero da apolice" },
  { key: "data_inicio", label: "Inicio da vigencia" },
  { key: "data_fim", label: "Fim da vigencia" },
  { key: "valor_segurado", label: "Valor segurado" },
